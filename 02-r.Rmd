...
-   Show margin (aim to limit line of code 80 characters)
...
The sections can be collapsed and are also listed in the , especially when combined with the document outline pane:

![](images/doc-outline.png)

### ViewPipeSteps addin

The pipe `%>%` is useful for reading and writing code, but can make debugging cumbersome. The `ViewPipeSteps` addin lets you view the output of your pipe chain after each step. To install:
