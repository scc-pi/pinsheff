...
> Reproducible Analytical Pipelines (RAP) focus on the use of open-source analytical tools (e.g. R and Python scripting languages) and a variety of techniques from various fields such as software development, software engineering, analytics and collaboration, in order to deliver reproducible, testable and auditable analysis pipelines.
