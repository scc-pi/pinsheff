...
[SpatiaLite](https://www.gaia-gis.it/fossil/libspatialite/index) extends SQLite to support spatial data. The [RSQLite](https://cran.r-project.org/web/packages/RSQLite/vignettes/RSQLite.html) package includes the driver for our SpatiaLite database. 
