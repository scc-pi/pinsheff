...
These notes will be updated if we get to figuring out a setting that automatically toggles the proxy setting rather than you having change this manually.  
...
Which should show you some content similar to what you see when you just use the same URL ([http://api.zippopotam.us/us/90210](http://api.zippopotam.us/us/90210)) in a browser: 
...
* Type "script address" into Edge i.e. [http://172.29.3.101/proxy.pac](http://172.29.3.101/proxy.pac)  
