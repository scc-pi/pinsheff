...
You don't have to be familiar with version control, Git and GitHub to make use of these notes or the contents of the [scc-pi](https://github.com/scc-pi) repositories. Visualisations or using R Markdown are better starting points than version control if you're new to scripting and R.
