...
As an additional precaution, any projects related to such information should be held in a private repository and [`.Rdata`](https://bookdown.org/ndphillips/YaRrr/rdata-files.html) should also be included in the `.gitignore` file (see the section on [RStudio security & data protection](#pid)):
