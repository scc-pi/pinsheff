...
As a rule of thumb, use GIS with R if you're familiar with R but not ArcGIS and Python, [and]{.ul} your project has just [some]{.ul} spatial content. If your project is predominantly spatial, you should consider upskilling to ArcGIS. The GIS capabilities of R packages are increasingly competent. However, you'll be swimming against the tide if you don't take advantage of the Council's investment in the ArcGIS platform, tools and skills.

This chapter focusses on how you can include spatial data in your R project from the Council's ArcGIS platform, or other public data sources.
