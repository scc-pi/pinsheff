...
"[Rolldown](https://github.com/yihui/rolldown/blob/master/README.md) is an R Markdown extension that builds scroll-driven HTML documents for storytelling, a.k.a scrollytelling". It's similar to the ArcGIS StoryMaps that have proved popular and people might be familiar with.
