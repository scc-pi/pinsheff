...
The place to start understanding the purpose of functions and how to write them, is the relevant chapter in [Hadley's R for Data Science](https://r4ds.had.co.nz/functions.html#functions). 
...
Tidy evaluation in particular, I'm not comfortable enough with yet to try and explain. I'm getting better at using it, but I've not fully understood it yet. [Hadley's Advanced R](https://adv-r.hadley.nz/) book is where you should look for an explanation:   
