...
1. open-source programming languages and flexibility to add more (Python, R, Julia, JavaScript, C++, Java/Scala etc.) - *R & Python BI Team laptops, R on OSCAR desktop*  
...
> In summary, some SCC data analysts have access to all of these minimum criteria with the exception of shared storage e.g. Azure Blob storage.
...
1. continuous integration tools, for example, GitHub Actions, GitLab CI, Travis CI, Jenkins, Concourse - *trialing GitHub Actions but CI limited by the existing security considerations*  

1. make-like tools for reproducible workflows, for example, make - *identified the potential value of [targets](https://books.ropensci.org/targets/) r package, but not yet tested it*  
...
> In summary, SCC data analysts don't have access to most of the platforms needed for further development of RAPs. Docker and targets could be trialled. GitHub is being trialled and purchasing would ease some current security restrictions and could include CI and server requirements. No consideration yet of orchestration systems or big data tools.   
