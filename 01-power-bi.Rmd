...
Power BI is a tool for combining, analysing, and visualising data, and sharing the results. It's a Microsoft product, orginally an Excel add-in, that fits well with the Council's move to Micorsoft Azure based services. It's also reasonably priced compared to alternative tools such as Tableau (arguably a higher quality option), so is now the main corporate tool for data analysis. Or more accurately, it's the main alternative to Excel.
...
The **Power BI Report Server** (<https://sccvmazpbi01.sheffield.gov.uk/reports>) is currently the default Council option for sharing your Power BI reports. Contact Keith Dunk to request a new folder on the Report Server and control of it. You can upload a report and give permissions just to that report, but will need to share a link to the report. Unless you give them permission to the folder they cannot navigate to it, you can give *browser* access to the folder and the report so they can open it. Click the ... at the side of the folder name and select *manage* and then *security* (this is the same once you have reports uploaded). You need to use the user ID, which you can find in the *Alias* field in the *Global Address List* in Outlook.
