...
This Power BI section is likely to be suerseded fairly soon by an MS Teams site being setup by Jess Kavanagh. It will help collate and disseminate the learning shared by Giles Robinson, Sam Jenner, Paul Haine and others.
...
The **Power BI report server** (<https://sccvmazpbi01.sheffield.gov.uk/reports>) is currently the default Council option for sharing your Power BI reports. Contact Keith Dunk to request a new folder on the Report Server and control of it.
...
To upload reports to the report server, for version compatibility reasons, you need to use the the May 2021 version of **Power BI desktop**, which is available from the Council's Software Centre on your laptop. If you have a different version, remove it and install the Software Centre version.
...
Paul Haine coordinates the SCC **Power BI user group** that meets monthly. The user group is aimed at Power BI *designers* and *administrators* rather than *business users*.

## Further resources

### Business users

For Power BI reporting server: ...

For Power BI service: [Explore what Power BI can do for you](https://docs.microsoft.com/en-gb/learn/modules/explore-power-bi-service/), a one hours online Microsoft learning module.

### Designers

A good way to quickly get familiar with Power BI is the free [Power BI Dashboard in a Day](https://powerbi.microsoft.com/en-us/diad/) online workshop, indirectly provided by Microsoft.
